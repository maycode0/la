...
from train_classifier import Model,NLI_infer_BERT,NLI_infer_RoBERTa
...
def run_attack():
    ...
    parser.add_argument("--target_model",
                        ...
                        default='bert',
                        # required=True,
                        choices=['wordLSTM', 'bert', 'wordCNN','roberta','gpt2'],
    ...
    if args.target_model == "wordCNN":
        ...
        max_seq_length = 256
        model = NLI_infer_RoBERTa(default_model_path, nclasses=args.nclasses, max_seq_length=max_seq_length)
